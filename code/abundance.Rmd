...
rect(0.8, (mean(relic.soil$prop) + 0.025), 1.2, (mean(relic.soil$prop)- 0.025), col = "NA", border = "black", lwd = 2)

rect(1.8, (mean(relic.sed$prop) + 0.025), 2.2, (mean(relic.sed$prop)- 0.025), col = "NA", border = "black", lwd = 2)

rect(2.8, (mean(relic.feces$prop) + 0.025), 3.2, (mean(relic.feces$prop) - 0.025), col = "NA", border = "black", lwd = 2)

rect(3.8, (mean(relic.water$prop) + 0.025), 4.2, (mean(relic.water$prop) - 0.025), col = "NA", border = "black", lwd = 2)
