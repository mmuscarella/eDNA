...
layout(matrix(c(3,3,1,2), 2, 2, byrow=T), heights=c(4, 3))
par(mar = c(4, 4, 1, 5) + 0.5, oma = c(1, 2, 1, 1))
...
# Conceptual Model
img <- readPNG("../figures/Fig1a.png")
plot.new()
par(mar = c(0, 0, 0, 0), xpd = T)
rasterImage(img, xleft = -0.19, xright = 1.15, ybottom = -0.275, 
            ytop = 1.25,interpolate = F)
text(x = 1, y = 1.1, "A", cex = 1.5, font = 2)
text(x = -0.15, y = -0.325, "B", cex = 1.5, font = 2)
text(x = 0.53, y = -0.325, "C", cex = 1.5, font = 2)
...
par(mar = c(4, 4, 1, 5) + 0.5, oma = c(0, 1, 1, 0))
