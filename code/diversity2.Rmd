...
rect(0.8, (mean(rich.soil$rich.ratio) + 0.025), 1.2, 
     (mean(rich.soil$rich.ratio)- 0.025), col = "NA", border = "black", lwd = 2)

rect(1.8, (mean(rich.sed$rich.ratio) + 0.025), 2.2, 
     (mean(rich.sed$rich.ratio)- 0.025), col = "NA", border = "black", lwd = 2)

rect(2.8, (mean(rich.feces$rich.ratio) + 0.025), 3.2, 
     (mean(rich.feces$rich.ratio) - 0.025), col = "NA", border = "black", lwd = 2)

rect(3.8, (mean(rich.water$rich.ratio) + 0.025), 4.2, 
     (mean(rich.water$rich.ratio) - 0.025), col = "NA", border = "black", lwd = 2)
...
# rect(xleft, ybottom, xright, ytop)
rect(0.8, (mean(even.soil$even.ratio) + 0.025), 1.2, 
     (mean(even.soil$even.ratio)- 0.025), col = "NA", border = "black", lwd = 2)

rect(1.8, (mean(even.sed$even.ratio) + 0.025), 2.2, 
     (mean(even.sed$even.ratio)- 0.025), col = "NA", border = "black", lwd = 2)

rect(2.8, (mean(even.feces$even.ratio) + 0.025), 3.2, 
     (mean(even.feces$even.ratio) - 0.025), col = "NA", border = "black", lwd = 2)

rect(3.8, (mean(even.water$even.ratio) + 0.025), 4.2, 
     (mean(even.water$even.ratio) - 0.025), col = "NA", border = "black", lwd = 2)
...
# rect(xleft, ybottom, xright, ytop)
rect(0.8, (mean(phylo.soil$phylo.ratio) + 0.025), 1.2, 
     (mean(phylo.soil$phylo.ratio)- 0.025), col = "NA", border = "black", lwd = 2)

rect(1.8, (mean(phylo.sed$phylo.ratio) + 0.025), 2.2, 
     (mean(phylo.sed$phylo.ratio)- 0.025), col = "NA", border = "black", lwd = 2)

rect(2.8, (mean(phylo.feces$phylo.ratio) + 0.025), 3.2, 
     (mean(phylo.feces$phylo.ratio) - 0.025), col = "NA", border = "black", lwd = 2)

rect(3.8, (mean(phylo.water$phylo.ratio) + 0.025), 4.2, 
     (mean(phylo.water$phylo.ratio) - 0.025), col = "NA", border = "black", lwd = 2)
