...
## Alpha Ratios
```{r}
png(filename="../figures/Figure3-Alpha2.png",
...
# Richness Panel
rich.plot <- plot(jitter(rep(1, nrow(rich.2[ which(rich.2$env == "feces"),])), amount = 0.1),rich.feces$rich.ratio, 
      ylim = c(0.5, 1.5), xlim = c(0.5, 4.5), pch = 21, bg = "lightgrey", lwd = 2,
      cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5,
      las = 1, ylab = "", xlab = "")
      box(lwd = 2)
points(jitter(rep(2, nrow(rich.2[ which(rich.2$env == "sed"),])), amount = 0.1),rich.sed$rich.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(3, nrow(rich.2[ which(rich.2$env == "soil"),])), amount = 0.1),rich.soil$rich.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(4, nrow(rich.2[ which(rich.2$env == "water"),])), amount = 0.1),rich.water$rich.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7) 
...
segments(0.85, rich.table$mean[1], 1.15, rich.table$mean[1], lwd = 2)
segments(1.85, rich.table$mean[2], 2.15, rich.table$mean[2], lwd = 2)
segments(2.85, rich.table$mean[3], 3.15, rich.table$mean[3], lwd = 2)
segments(3.85, rich.table$mean[4], 4.15, rich.table$mean[4], lwd = 2)
...
# Evenness Panel
even.plot <- plot(jitter(rep(1, nrow(even.2[ which(even.2$env == "feces"),])), amount = 0.1),even.feces$even.ratio, 
      ylim = c(0.5, 1.5), xlim = c(0.5, 4.5), pch = 21, bg = "lightgrey", lwd = 2,
      cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5,
      las = 1, ylab = "", xlab = "")
      box(lwd = 2)
points(jitter(rep(2, nrow(even.2[ which(even.2$env == "sed"),])), amount = 0.1), even.sed$even.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(3, nrow(even.2[ which(even.2$env == "soil"),])), amount = 0.1), even.soil$even.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(4, nrow(even.2[ which(even.2$env == "water"),])), amount = 0.1), even.water$even.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
abline(h = 1, lty = 3, lwd = 2)
...
segments(0.85, even.table$mean[1], 1.15, even.table$mean[1], lwd = 2)
segments(1.85, even.table$mean[2], 2.15, even.table$mean[2], lwd = 2)
segments(2.85, even.table$mean[3], 3.15, even.table$mean[3], lwd = 2)
segments(3.85, even.table$mean[4], 4.15, even.table$mean[4], lwd = 2)
...
# Phylo Panel
phylo.plot <- plot(jitter(rep(1, nrow(phylo.2[ which(phylo.2$env == "feces"),])), amount = 0.1),phylo.feces$phylo.ratio, 
      ylim = c(0.5, 1.5), xlim = c(0.5, 4.5), pch = 21, bg = "lightgrey", lwd = 2,
      cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5,
      las = 1, ylab = "", xlab = "")
      box(lwd = 2)
points(jitter(rep(2, nrow(phylo.2[ which(phylo.2$env == "sed"),])), amount = 0.1), phylo.sed$phylo.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(3, nrow(phylo.2[ which(phylo.2$env == "soil"),])), amount = 0.1), phylo.soil$phylo.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(4, nrow(phylo.2[ which(phylo.2$env == "water"),])), amount = 0.1), phylo.water$phylo.ratio, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
abline(h = 1, lty = 3, lwd = 2)
...
segments(0.85, phylo.table$mean[1], 1.15, phylo.table$mean[1], lwd = 2)
segments(1.85, phylo.table$mean[2], 2.15, phylo.table$mean[2], lwd = 2)
segments(2.85, phylo.table$mean[3], 3.15, phylo.table$mean[3], lwd = 2)
segments(3.85, phylo.table$mean[4], 4.15, phylo.table$mean[4], lwd = 2)
...
# Show Plot
img <- readPNG("../figures/Figure3-Alpha2.png")
grid.raster(img)
```
...
points(eDNA.prop.sub2$prop, rich.2[order(rich.2$qPCR.match), ]$rich.ratio,
...
points(eDNA.prop.sub2$prop, even.2[order(even.2$qPCR.match), ]$even.ratio,
       pch = 22, bg = "gray", lwd = 2, cex = 2)
...
points(eDNA.prop.sub2$prop, phylo.2[order(phylo.2$qPCR.match), ]$phylo.ratio,
       pch = 22, bg = "gray", lwd = 2, cex = 2)
...
centroid.div.t <- ddply(centroid.div, .(env, qPCR.match, prop),
                      summarize, cent.dist = mean(cent.dist, na.rm = TRUE))
...
cent.tax.feces <- centroid.div.t[ which(centroid.div.t$env == "feces"),]
cent.tax.feces.ttest <- t.test(cent.tax.feces$cent.dist, mu = 1)

cent.tax.sed <- centroid.div.t[ which(centroid.div.t$env == "sed"),]
cent.tax.sed.ttest <- t.test(cent.tax.sed$cent.dist, mu = 1)

cent.tax.soil <- centroid.div.t[ which(centroid.div.t$env == "soil"),]
cent.tax.soil.ttest <- t.test(cent.tax.soil$cent.dist, mu = 1)

cent.tax.water <- centroid.div.t[ which(centroid.div.t$env == "water"),]
cent.tax.water.ttest <- t.test(cent.tax.water$cent.dist, mu = 1)
```
...
cent.phylo.feces <- centroid.div.p[ which(centroid.div.p$env == "feces"),]
cent.phylo.feces.ttest <- t.test(cent.phylo.feces$cent.dist, mu = 1)

cent.phylo.sed <- centroid.div.p[ which(centroid.div.p$env == "sed"),]
cent.phylo.sed.ttest <- t.test(cent.phylo.sed$cent.dist, mu = 1)

cent.phylo.soil <- centroid.div.p[ which(centroid.div.p$env == "soil"),]
cent.phylo.soil.ttest <- t.test(cent.phylo.soil$cent.dist, mu = 1)

cent.phylo.water <- centroid.div.p[ which(centroid.div.p$env == "water"),]
cent.phylo.water.ttest <- t.test(cent.phylo.water$cent.dist, mu = 1)
...
centroid.tax.plot <- plot(jitter(rep(1, nrow(centroid.div.t[ which(centroid.div.t$env == "feces"),])), 
      amount = 0.1),cent.tax.feces$cent.dist, 
      ylim = c(0.5, 1.5), xlim = c(0.5, 4.5), pch = 21, bg = "lightgrey", lwd = 2,
      cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5,
      las = 1, ylab = "", xlab = "")
      box(lwd = 2)
points(jitter(rep(2, nrow(centroid.div.t[ which(centroid.div.t$env == "sed"),])), amount = 0.1), cent.tax.sed$cent.dist, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(3, nrow(centroid.div.t[ which(centroid.div.t$env == "soil"),])), amount = 0.1), cent.tax.soil$cent.dist, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(4, nrow(centroid.div.t[ which(centroid.div.t$env == "water"),])), amount = 0.1), cent.tax.water$cent.dist, pch = 21, 
       bg = "lightgrey", lwd = 2, cex = 1.7)
abline(h = 1, lty = 3, lwd = 2)
...
segments(0.85, cent.dist.table$mean[1], 1.15, cent.dist.table$mean[1], lwd = 2)
segments(1.85, cent.dist.table$mean[2], 2.15, cent.dist.table$mean[2], lwd = 2)
segments(2.85, cent.dist.table$mean[3], 3.15, cent.dist.table$mean[3], lwd = 2)
segments(3.85, cent.dist.table$mean[4], 4.15, cent.dist.table$mean[4], lwd = 2)
