...
# Bray Curtis Plot
centroid.tax.plot <- plot(jitter(rep(1, length(cent.tax.soil$cent.tax.dist)), 
      amount = 0.1),cent.tax.soil$cent.tax.dist, 
      ylim = c(0.5, 1.5), xlim = c(0.5, 4.5), pch = 21, bg = "lightgrey", col = "lightgrey", 
      lwd = 2, cex = 1.7, yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5,
      las = 1, ylab = "", xlab = "")
      box(lwd = 2)

points(jitter(rep(2, length(cent.tax.sed$cent.tax.dist)), amount = 0.1), cent.tax.sed$cent.tax.dist, 
       pch = 21, bg = "lightgrey", col = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(3, length(cent.tax.feces$cent.tax.dist)), amount = 0.1), cent.tax.feces$cent.tax.dist, 
       pch = 21, bg = "lightgrey", col = "lightgrey", lwd = 2, cex = 1.7)
points(jitter(rep(4, length(cent.tax.water$cent.tax.dist)), amount = 0.1), cent.tax.water$cent.tax.dist, 
...
abline(h = 1, lty = 3, lwd = 2)
arrows(x0 = c(1,2,3,4), y0 = t.cent.tax.dist.table$mean, y1 = t.cent.tax.dist.table$LCI, angle = 90,
       length = 0.1, lwd = 2)
arrows(x0 = c(1,2,3,4), y0 = t.cent.tax.dist.table$mean, y1 = t.cent.tax.dist.table$UCI, angle = 90,
       length = 0.1, lwd = 2)
