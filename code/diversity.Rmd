...
design       <- "../data/relicDNA_Design.txt"
shared       <- "../mothur/output/relicDNA.bac.final.shared"
tax          <- "../mothur/output/relicDNA.bac.final.0.03.taxonomy"
```
...
OTU.tre <- read.tree("../mothur/output/relicDNA.bac.rename.tree")
```
...
```{r}
phylo.dist <- read.delim("../mothur/output/relicDNA.bac.tree.weighted.phylip.dist",
