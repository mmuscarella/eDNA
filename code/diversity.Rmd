...
mtext("A", side = 3, outer = F, font = 2, at = -0.5, padj = 1, cex = 1.5)
...
mtext("B", side = 3, outer = F, font = 2, at = -0.5, padj = 1, cex = 1.5)
...
mtext("C", side = 3, outer = F, font = 2, at = -0.5, padj = 1, cex = 1.5)
...
layout(matrix(c(1:3), byrow = T))
par(mar = c(1, 4.5, 0.5, 1), oma = c(6, 2, 1.5, 1))
...
mtext("A", side = 3, outer = F, font = 2, at = -0.28, padj = 1, cex = 1.5)
...
mtext("B", side = 3, outer = F, font = 2, at = -0.28, padj = 1, cex = 1.5)
...
legend("topleft", cex = 1.2,
       ...
       lty = 2, bty = "n", col = "gray")
mtext(side = 1, "Proportion eDNA", line = 3.5, cex = 1.5)
mtext(side = 2, "Faiths D Ratio", line = 3.5, cex = 1.5)
...
mtext("C", side = 3, outer = F, font = 2, at = -0.28, padj = 1, cex = 1.5)
...
mtext("A", side = 3, outer = T, font = 2, at = 0.05, padj = 2, cex = 1.5)
...
mtext("B", side = 3, outer = T, font = 2, at = 0.49, padj = 2, cex = 1.5)
...
mtext("A", side = 2, outer = T, font = 2, at = 1, padj = 1, 
      cex = 1.25, las = 1)
...
mtext("B", side = 2, outer = T, font = 2, at = 0.5, padj = 1, 
      cex = 1.25, las = 1)
...
par(mar = c(0.5, 4.5, 0.5, 1), oma = c(4.5, 2, 1.5, 1))
...
# Major Axes
axis(side = 2, lwd.ticks = 2, tck = -0.02, cex.axis = 1, las = 1,
    labels = T, at = c(0.5, 1, 1.5, 2))
axis(side = 4, lwd.ticks = 2, cex.axis = 1, las = 1,
   labels = F, at = c(0.5, 1, 1.5, 2))
axis(side = 1, lwd.ticks = 2, tck = -0.02, cex.axis = 0.9, las = 1,
...
mtext(side = 1, "Proportion eDNA", line = 3)
mtext('Centroid Distance Ratio\n(UniFrac Distance)', side = 2, 
        outer = F, cex = 1.25, line = 2.5, adj = 0.5)
