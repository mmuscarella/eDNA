...
rich.reg <- lm(rich.2[order(rich.2$qPCR.match), ]$rich.ratio ~ eDNA.prop.sub2$prop + eDNA.prop.sub2$env )
summary(rich.reg) 
...
Representatives were picked by on the most abundant unique sequence in each OTU.
...
> FastTree -gtr -nt -gamma -fastest eDNA.bac.final.0.03.rep.fasta >> eDNA.bac.tree

Output: 
ML-NNI round 10: LogLk = -5469999.258 NNIs 19175 max delta 6.02 Time 5310.73 (final)
Optimize all lengths: LogLk = -5469914.139 Time 5434.12  
Gamma(20) LogLk = -5471162.936 alpha = 1.041 rescaling lengths by 1.647   
Total time: 5994.32 seconds Unique: 174292/174292 Bad splits: 910/174289 Worst delta-LogLk 7.944
```
