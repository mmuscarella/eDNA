...
> FastTree -gtr -nt -gamma -fastest eDNA.bac.final.0.03.rep.rename.fasta >> eDNA.bac.tree
...
OTU.tre <- read.tree("../mothur/output/eDNA.bac.tree")
```
...
arrows(x0 = c(1,2,3,4), y0 = phylo.table$mean, y1 = phylo.table$UCI, angle = 90,
       length=0.1, lwd = 2)
points(c(1:4), phylo.table$mean,pch = 22, cex = 3, bg = "white", lwd = 2)
